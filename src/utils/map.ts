export class Path{
    ...
    constructor(markerOptions:{
        cuerrentMarkerOptions: google.maps.ReadonlyMarkerOptions,
        endMarkerOptions: google.maps.ReadonlyMarkerOptions
    }){

        const {cuerrentMarkerOptions, endMarkerOptions}  = markerOptions;
        this.currentMarker  = new google.maps.Marker(cuerrentMarkerOptions);
...
export class Map{
    ...
    addPath(
        ...
        this.paths[id] = new Path({
            cuerrentMarkerOptions: {...currentMarkerOptions,map:this.map},
